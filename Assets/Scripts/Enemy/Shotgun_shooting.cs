...
public class Shotgun_shooting: MonoBehaviour
{
    ...
    public void Fire()
    {
        ...
        Rigidbody shellInstance1 = Instantiate(m_Shell, m_FireTransform1.position, m_FireTransform1.rotation) as Rigidbody;
        ...
        shellInstance1.velocity = m_CurrentLaunchForce * m_FireTransform1.forward; ;
